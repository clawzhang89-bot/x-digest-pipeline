...
11. 如果有 research pack，请优先把其中已经核验过的事实、时间线、反方观点和行业格局吃进去；不要只围绕 seed 原帖写。
12. 如果 research pack 里还没有真实来源结果，请把它当成写作约束与补充角度，而不是假装已经有了外部证据。
13. 如果材料其实不足以支持一篇独立文章，请明确说明“NOT_ENOUGH_MATERIAL”。
